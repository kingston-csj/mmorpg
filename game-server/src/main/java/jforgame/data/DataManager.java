 ...
 * To implement secondary cache, simply extend {@link Container}, refer to {@link ResourceProperties#getContainerScanPath()} parameter
 */
public class DataManager implements DataRepository {
    ...
    private final ResourceProperties options;
    ...
    public DataManager(ResourceProperties options, DataReader dataReader) {
