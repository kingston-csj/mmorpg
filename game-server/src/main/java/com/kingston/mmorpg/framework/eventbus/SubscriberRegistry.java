...
class SubscriberRegistry {
	...
	private final ConcurrentMap<Class<? extends BaseEvent>, CopyOnWriteArraySet<Subscriber>> subscribers = new ConcurrentHashMap<Class<? extends BaseEvent>, CopyOnWriteArraySet<Subscriber>>();

	void register(Object listener) {
		Map<Class<? extends BaseEvent>, Subscriber> listenerMethods = findAllSubscribers(listener);
