...
import org.forfun.mmorpg.framework.cache.EntityCacheServiceFactoryBean;
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        ReflectionUtils.doWithFields(targetClass, field -> {
            if (field.isAnnotationPresent(EntityCacheAutowired.class) &&
                    org.forfun.mmorpg.framework.cache.BaseEntityCacheService.class.isAssignableFrom(field.getType())) {
