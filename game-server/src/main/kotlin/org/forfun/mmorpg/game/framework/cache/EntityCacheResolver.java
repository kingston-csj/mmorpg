...
public class EntityCacheResolver implements CacheResolver {
    ...
    public Collection<? extends Cache> resolveCaches(CacheOperationInvocationContext<?> context) {
        ...
        // 从目标对象获取实体类型
        if (target instanceof org.forfun.mmorpg.framework.cache.BaseEntityCacheService) {
            org.forfun.mmorpg.framework.cache.BaseEntityCacheService<?, ?> service = (BaseEntityCacheService<?, ?>) target;
